      ...
      {auth.currentUser.sudo == "user" && (
        <div className="container">
          <div className="text-loged">
            ...
            <p>
              Como abonar? Debe acercarse a nuestras oficinas ubicadas en Pte
              Roca 796, aceptamos pago en debito o contado
            </p>
          ...
          <div>
            ...
            <Modal isOpen={modalEliminar}>
              <ModalBody>
                ...
                {userSelected && userSelected.nombre}
              </ModalBody>
              <ModalFooter>
